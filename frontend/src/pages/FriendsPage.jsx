  ...
  useEffect(() => {
    ...
    console.log("user", user);
      ...
      try {
        ...
        const response = await axios.post('http://localhost:5000/get_friends', { username : username_user });
        const response_friends = response.data.friends;
        console.log("response", response);
        console.log("response_friends", response_friends);
        setFriends(response_friends);
    ...
    return (
      <div className="w-full bg-gray-700 rounded-full h-2.5 mt-2">
        <div 
          ...
          style={{ width: `${score>100? 98 : score}%` }}
        ></div>
      </div>
    );
  };
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-400">new friend</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    {renderSimilarityScore(friend.score)}
                    <span className="ml-2 text-sm text-gray-400">
                      {friend.score.toFixed(2)>100? 99.78: friend.score.toFixed(2)}%
                    </span>
                  </div>
